 ...
 * slug (from `window.customifyStarterSites.currentTheme`) and posts the
 ...
 *
 *     window.customifyStarterSitesRegisterStyleBuilder( 'astra', ( palette, font ) => {
 *         // return CSS string for Astra's var/selector convention
 *     } );
 *
 * Resolution order:
 *   1. external register via `customifyStarterSitesRegisterStyleBuilder( slug, fn )`
...
if ( typeof window !== 'undefined' ) {
	window.customifyStarterSitesRegisterStyleBuilder = registerStyleBuilder;
}
