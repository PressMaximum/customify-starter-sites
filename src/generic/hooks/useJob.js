 ...
 * interval.
 *
 * Polling cadence comes from `customifyStarterSites.pollIntervalMs` (set by
...
const INTERVAL_MS = ( window.customifyStarterSites && window.customifyStarterSites.pollIntervalMs ) || 2000;
